...
python -m app.ingest.cisa_ics          || echo "WARN: cisa_ics ingest failed, continuing"
...
python -m app.ingest.phmsa             || echo "WARN: phmsa ingest failed, continuing"
...
python -m app.classify.phmsa_enforcement

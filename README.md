...
Later stages add the remaining incident sources (security RSS; regulator incident notices are covered by the existing FERC/NERC enforcement path), combo scoring, GDELT-based classification, and a hiring/macro-trend layer.
